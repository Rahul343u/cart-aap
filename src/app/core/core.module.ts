...
@NgModule({
  declarations: [AddToCartPageComponent, CartPageComponent, HeaderComponent, FilterComponent, ShoppingListComponent, FooterComponent, SearchComponent, CartIconComponent, ShortComponent],
